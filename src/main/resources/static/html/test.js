...
(function () {
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            ...
            K(h._menuButton, "mousemove", function () {
                m || (W(h._menuButton, {backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover}), 0 >= navigator.userAgent.search("MSIE") && W(h._menuButton.childNodes[0], {WebkitFilter: "invert(100%)", filter: "invert(100%)"}))
            }, h.allDOMEventHandlers, !0);
    ...
    function va(h, m, B) {
        m.getAttribute("state") || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", W(m, {WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none"}));
        ...
        B && (m.setAttribute("state", B), m.setAttribute("type", "button"), W(m, {
            ...
            lineHeight: "0"
        }), m.setAttribute("title", h._cultureInfo[B + "Text"]), m.innerHTML = "<img src='" + kb[B].image + "' alt='" + h._cultureInfo[B + "Text"] + "' />", W(m.childNodes[0], {height: "95%", pointerEvents: "none"}))
    }
    ...
    var Ha = !1, U = {}, w = !!document.createElement("canvas").getContext, qa = {
        ...
        Ka = {en: {}}, v = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    var gb = function () {
            ...
            var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), r = "Sun Mon Tue Wed Thu Fri Sat".split(" "),
                w = "January February March April May June July August September October November December".split(" "),
                v = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), S = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, A = /[^-+\dA-Z]/g;
            return function (E, J, O) {
                ...
                var W = E[O + "Date"](), N = E[O + "Day"](),
                    ba = E[O + "Month"](), a = E[O + "FullYear"](), d = E[O + "Hours"](), c = E[O + "Minutes"](), b = E[O + "Seconds"](), e = E[O + "Milliseconds"](), f = U ? 0 : E.getTimezoneOffset();
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(), w = m.x1, v = m.y1, E = 0, J = 0, A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, I, K;
    ...
    v = Pa.Chart = function () {
        ...
        function m(a, d, c) {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ?
                ...
                }, this.allDOMEventHandlers), this._toolBar = document.createElement("div"), this._toolBar.setAttribute("class", "canvasjs-chart-toolbar"), W(this._toolBar, {position: "absolute", right: "1px", top: "1px"}), this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {
                    x1: 0,
                    y1: 0,
                    x2: this.width,
                    y2: this.height
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this._resetButton ? (W(this._resetButton, {
                    ...
                    K(this._resetButton, "mousemove", function () {
                        d || (W(a._resetButton, {backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s"}), 0 >= navigator.userAgent.search("MSIE") && W(a._resetButton.childNodes[0], {
        ...
        m.prototype._dispatchRangeEvent = function (a, d) {
            ...
            for (var e = 0; e < b.length; e++) if (r(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e]) for (var f = 0; f < this.axisY.length; f++) c[b[e]].push({viewportMinimum: this[b[e]][f].sessionVariables.newViewportMinimum, viewportMaximum: this[b[e]][f].sessionVariables.newViewportMaximum});
        ...
        m.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (s = 0; s < this.axisX2.length; s++) this.axisX2[s].crosshair && this.axisX2[s].crosshair.enabled && (this.axisX2[s].crosshair.hide(), this.axisX2[s].crosshair.dispatchEvent("hidden", {chart: this, axis: this.axisX2[s].options}, this.axisX2[s].crosshair));
                    for (s = 0; s < this.axisY.length; s++) this.axisY[s].crosshair && this.axisY[s].crosshair.enabled && (this.axisY[s].crosshair.hide(), this.axisY[s].crosshair.dispatchEvent("hidden", {chart: this, axis: this.axisY[s].options},
                        this.axisY[s].crosshair));
                    for (s = 0; s < this.axisY2.length; s++) this.axisY2[s].crosshair && this.axisY2[s].crosshair.enabled && (this.axisY2[s].crosshair.hide(), this.axisY2[s].crosshair.dispatchEvent("hidden", {chart: this, axis: this.axisY2[s].options}, this.axisY2[s].crosshair))
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = {
                    ...
                    var b = e ? this.dragStartPoint.x : this.plotArea.x1,
                        s = f ? this.dragStartPoint.y : this.plotArea.y1, D = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, k = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff)) if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                    (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), n.push({val1: q, val2: g}), s = !0; else if (!e) {
                    s = !1;
                    break
                }
            }
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, l = ma("indexLabelFontColor", n.dataPoint, n.dataSeries), t = ma("indexLabelFontSize", n.dataPoint, n.dataSeries), s = ma("indexLabelFontFamily", n.dataPoint, n.dataSeries),
                    D = ma("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = ma("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries);
                q = ma("indexLabelMaxWidth", n.dataPoint, n.dataSeries);
                g = ma("indexLabelWrap", n.dataPoint, n.dataSeries);
                var m = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries), u = ma("indexLabelLineColor", n.dataPoint, n.dataSeries),
                    ...
                    b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, x = {percent: null, total: null}, z = null;
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        ...
                        u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), z = !0; else {
                            ...
                            if (0 < n[u].markerSize || 0 < k.markerSize) G = k.getMarkerProperties(u, r, x, c), f.push(G), C = P(C), w && f.push({x: r, y: x, ctx: b, type: G.type, size: G.size, color: C, borderColor: C, borderThickness: G.borderThickness});
                            (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({chartType: "stepLine", dataPoint: n[u], dataSeries: k, point: {x: r, y: x}, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: t})
                        }
                        c.stroke();
                        w && b.stroke()
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) for (m = !1, r = 0; r < n.length; r++) if (u = n[r].getTime ? n[r].x.getTime() : n[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m))) if ("number" !== typeof n[r].y) 0 < r && !m && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                        ...
                        (n[r].indexLabel || k.indexLabel || n[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({chartType: "spline", dataPoint: n[r], dataSeries: k, point: {x: u, y: m}, direction: 0 > n[r].y === a.axisY.reversed ? 1 : -1, color: t});
                        m = !1
                    }
                    d(x)
                }
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
        ...
        m.prototype.renderStackedColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea,
                    f = [], l = [], s = [], D = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, t = a.axisX.dataInfo.minDiff;
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], s = [], D = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
        ...
        m.prototype.renderBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ?
                    this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
                isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
        ...
        m.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], s = [], D = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                t = this.options.dataPointWidth ?
                    ...
                    if (0 < t.length) {
                        ...
                        for (var ka = !0; h < t.length; h++) if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka))) if ("number" !==
                            ...
                            0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h,
                                r, u, f), D.push(m), aa = P(aa), w && D.push({x: r, y: u, ctx: l, type: m.type, size: m.size, color: aa, borderColor: aa, borderThickness: m.borderThickness}));
        ...
        m.prototype.renderSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    l = P(l);
                    e.fillStyle = l;
                    var l = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null, y = [];
                    if (0 < p.length) {
                        ...
                        var C = "solid";
                        if (b.setLineDash) {
                            var A = J(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType, E = J(C, n.lineThickness);
                            b.setLineDash(E)
                        }
                        for (t = !1; q < p.length; q++) if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t))) if ("number" !== typeof p[q].y) 0 < q && !t && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, C = n.nullDataLineDashType) : (d(), y = [])), t = !0;
                            ...
                            (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: {x: g, y: t}, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x});
                            t = !1
                        }
                        d();
                        ba.drawMarkers(l)
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    h = [];
                    d = !0;
                    var r = 0, m, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, G = null;
                    c = !1;
                    if (0 < t.length) {
                        ...
                        var M = "solid";
                        if (f.setLineDash) {
                            var T = J(g.nullDataLineDashType, g.lineThickness), M = g.lineDashType, B = J(M, g.lineThickness);
                            f.setLineDash(B)
                        }
                        for (; r < t.length; r++) if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin ||
                            ...
                            "number" !== typeof t[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, G = n, M = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(m, aa), f.lineTo(m, u), w && (l.lineTo(m, aa), l.lineTo(m, u))) :
                                (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), G = {x: m, y: u}), c = d = !1) : (f.lineTo(m, aa), w && l.lineTo(m, aa), f.lineTo(m, u), w && l.lineTo(m, u), 0 == r % 250 && b()), n = {
                                x: m,
                                y: u
                            ...
                            })), (t[r].indexLabel || g.indexLabel || t[r].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({chartType: "stepArea", dataPoint: t[r], dataSeries: g, point: {x: m, y: u}, direction: 0 > t[r].y === a.axisY.reversed ? 1 : -1, color: C}))
                        }
                        b();
                        ba.drawMarkers(h)
                    }
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], s = this.plotArea, h = [],
                    k = [], n = [], p = [], q = 0, g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m = this._eventManager.ghostCtx, u, y, x;
                w && m.beginPath();
                b.save();
                w && m.save();
                b.beginPath();
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q], ga = null, ga = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : {x: f, y: null};
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = [], h = [], k = [], n = [], p = [], q = 0, g, t, r, m, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx;
                b.save();
                w && x.save();
                b.beginPath();
        ...
        m.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = 0, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var m =
                    ...
                    if (0 < y.length) for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++) if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                        ...
                        var z = h - t / 2 << 0, G = z + t << 0, f = u.options.fallingColor ? u.fallingColor : u._colorSet[0], e = y[s].color ? y[s].color : u._colorSet[0], C = Math.round(Math.max(1, 0.15 * t)), v = 0 === C % 2 ? 0 : 0.5, A = u.dataPointIds[s];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    ...
                    "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                        ...
                        var G = s - t / 2 << 0, C = s + t / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0], v = Math.round(Math.max(1, 0.15 * t)), A =
                                0 === v % 2 ? 0 : 0.5, M = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e,
                            T = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : v, B = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                            aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? t : y.whiskerLength : x[l].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) * t / 100 > t ?
                                t : parseInt(aa) * t / 100 : t, ga = 1 === Math.round(T) % 2 ? 0.5 : 0, na = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e,
                            E = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : v, F = 1 === Math.round(E) % 2 ? 0.5 : 0, I = x[l].stemDashType ? x[l].stemDashType : y.stemDashType,
                            K = x[l].lineColor ? x[l].lineColor : x[l].color ? y.lineColor ? y.lineColor : x[l].color : y.lineColor ? y.lineColor : e, O = "number" === typeof x[l].lineThickness ? x[l].lineThickness :
                                "number" === typeof y.options.lineThickness ? y.lineThickness : v, R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType, L = 1 === Math.round(O) % 2 ? 0.5 : 0, S = y.upperBoxColor, U = y.lowerBoxColor, ra = r(y.options.fillOpacity) ? 1 : y.fillOpacity,
                            Q = y.dataPointIds[l];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length) for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                        ...
                        var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0, fa = a.axisX.reversed ? m - k << 0 : m + k << 0,
        ...
        m.prototype.renderError = function (a) {
            var d =
                a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y], z = this.data[x], v = z.dataPoints, C = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1, A = 0;
                    ...
                    if (0 < v.length) for (var B = z._colorSet, s = 0; s < v.length; s++) {
                        ...
                        if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                            ...
                            b && n > p && (ka = n, n = p, p = ka);
                            ka = z.dataPointIds[s];
                            this._eventManager.objectMap[ka] = {id: ka, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: s, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: T, whiskerProperties: M};
        ...
        m.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                    null, e = this.plotArea, f = 0, l, s, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < p.length) {
                        ...
                        for (var M = !0; g < p.length; g++) if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !M))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                            ...
                            q || M ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                                C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = B, C = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(t, r), w && e.lineTo(t, r), h.push({x: t, y1: r, y2: m})) : (b.beginPath(), b.moveTo(t, r), y = {
                                x: t,
                                y: r
                            }, h = [], h.push({x: t, y1: r, y2: m}), w && (e.beginPath(), e.moveTo(t, r))), M = q = !1) : (b.lineTo(t, r), h.push({x: t, y1: r, y2: m}), w && e.lineTo(t, r), 0 == g % 250 && d());
                            u = n.dataPointIds[g];
        ...
        m.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    e = null, f = this.plotArea, l = 0, s, h, k, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    var u = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1, y = 1 === Math.round(u) %
                    2 ? -0.5 : 0;
        ...
        m.prototype.renderPie = function (a) {
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++) if (f = !1, s = g[k], s.indexLabelText) {
                            ...
                            if (null !== l) {
                                ...
                                if (q = 0 > z) {
                                    ...
                                    var r = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height / 2, m = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2, t = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width,
            ...
            var m = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, t = 2, w, v = 1.3, u = 20 / 180 * Math.PI, y = 6, x = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, z = 0;
                a = !1;
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, D = [], x = [], v = {percent: null, total: null}, z = null, C = 0; C < y.length; C++) t = Q[C], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, D[C] = K - t - W;
                    t = 0.5 * W;
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                        ...
                        S.roundRect || Ca(S);
                        c = new ja(S, {fontSize: f, fontFamily: l, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: m, backgroundColor: d, maxWidth: s, maxHeight: !1 === x[C] ? q ? 4.28571429 * f : 1.5 * f : x[C], text: b, padding: da});
                        c.measureText();
                        H.push({
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var T = x.x1 + B, K = x.x2 - B, O = x.y1 + z, R = x.y2 - z, S = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints &&
                    ...
                    var B = T + a / 2, Z = T, X = T + a, oa = u.reversed ? R : O, L = B - F / 2, ba = B + F / 2, Ba = u.reversed ? O + P : R -
                        P, ra = u.reversed ? O : R;
                    a = [];
                    var B = [], Q = [], I = [], V = O, ca, $ = (Ba - oa) / (L - Z), ea = -$, T = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== T) {
                        ...
                        if (!M) for (F = 0; F < y.length; F++) C = u.dataPointIds[F], a = {id: C, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: Q[u.reversed ? y.length - 1 - F : F]}, A._eventManager.objectMap[C] = a;
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var l =
                    "#percent", h = "#total", r = this.getPercentAndTotal(c, d), h = isNaN(r.total) ? h : r.total, l = isNaN(r.percent) ? l : r.percent;
                do {
                    r = "";
        ...
        R.prototype.setLayout = function () {
            var a =
                    this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, l = 0,
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !==
                    ...
                    var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : S.getDefaultLegendMarker(p._linkedSeries.type) : S.getDefaultLegendMarker(p.type) : p.markerType,
                        ...
                        }) : p.name, t = p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? r(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor : p._colorSet[0],
                        w = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, v = p.legendMarkerBorderColor ? p.legendMarkerBorderColor : p.markerBorderColor,
                    ...
                    q = {markerType: q, markerColor: t, text: g, textBlock: null, chartType: p.type, markerSize: w, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: v, markerBorderThickness: u};
                    m.push(q)
                    ...
                    var x = p.dataPoints[y], q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : S.getDefaultLegendMarker(p.type), g = x.legendText ? x.legendText :
                            p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({chart: this.chart, legend: this.options, dataSeries: p, dataPoint: x}) : x.name ? x.name : "DataPoint: " + (y + 1),
                        t = x.legendMarkerColor ? x.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length], w = 0.75 * this.lineHeight,
                        ...
                        u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0, g = this.chart.replaceKeywordsWithValue(g, x, p, y),
            ...
            for (n = 0; n < this.items.length; n++) q = m[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] =
                {id: q.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex};
            this.markerSize = w;
            this.rows = k;
        ...
        R.prototype.render = function () {
            ...
            for (var h = 0, r = 0; r < l.length; r++) {
                for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), m = d + h, w = g;
                    ...
                    if ("error" === q.chartType) {
                        ...
                        this.ctx.beginPath();
                        var v = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = m + 0.15 * this.lineHeight, y = 0.7 * this.lineHeight, x = y +
        ...
        S.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {dataPoint: null, distance: Infinity, index: NaN}, b = null, e = 0, f = 0, l = 1, h = Infinity, r = 0, k = 0, n = 0;
        ...
        S.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            var b = [], e = 0, f = 0, l = 1, h = !1, r = Infinity, k = 0, n =
                0, p = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({x: a, y: d}), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var w = ma("markerSize", g, this) || 4, v = c ? 20 : w, m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                            ...
                            case "boxAndWhisker":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness /
                                    2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) b.push({dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d))}), h = !0;
                                break;
                            case "candlestick":
        ...
        A.prototype.createLabels = function () {
            ...
            a = !1;
            var p = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = p.length ? r(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0;
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                a || (a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.options, value: new Date(n), label: this.labels[n] ? this.labels[n] : null}) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Aa(n, this.valueFormatString, this.chart._cultureInfo),
                    a = new ja(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b]}) : r(this.options.label) ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                            ...
                            this.value = z;
                            k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z}) : r(this.options.label) ? da(r(c) ? z : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b]}) : r(this.options.label) ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString,
        ...
        ha.prototype.mouseEventHandler = function (a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
                    ...
                    e.dataPoints[b.dataPointIndex] : null, b.eventParameter = {x: c.x, y: c.y, dataSeries: e.options, dataPoint: f, dataPointIndex: b.dataPointIndex, dataSeriesIndex: b.dataSeriesIndex, chart: this.chart}, b.eventContext = {
